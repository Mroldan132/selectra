...
{
    // Este DTO contendrá todos los campos que se pueden editar desde el modal de personal.
    public class ActualizarPersonalDto : IDatosPersonalesBasicosDto
    {
        [MinLength(8)] // La clave es opcional, pero si se envía, debe tener un mínimo de 8 caracteres.
