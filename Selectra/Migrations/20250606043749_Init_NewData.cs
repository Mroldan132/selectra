...
{
    /// <inheritdoc />
    public partial class Init_NewData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ubigeoId = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: false),
                    departamentoId = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: false),
                    departamento = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    distritoId = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ubigeoNacimientoId = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: false),
                    ubigeoResidenciaId = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DatosPersonales_Ubigeos_ubigeoNacimientoId",
                        column: x => x.ubigeoNacimientoId,
                        principalTable: "Ubigeos",
                        principalColumn: "ubigeoId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DatosPersonales_Ubigeos_ubigeoResidenciaId",
                        column: x => x.ubigeoResidenciaId,
                        principalTable: "Ubigeos",
                        principalColumn: "ubigeoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Aspirantes", x => x.aspiranteId);
                    table.ForeignKey(
                        name: "FK_Aspirantes_DatosPersonales_datosPersonalesId",
                        column: x => x.datosPersonalesId,
                        principalTable: "DatosPersonales",
                        principalColumn: "datosPersonalesId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Aspirantes_NivelAcademicos_nivelAcademicoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Postulantes_Aspirantes_aspiranteId",
                        column: x => x.aspiranteId,
                        principalTable: "Aspirantes",
                        principalColumn: "aspiranteId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Aspirantes_datosPersonalesId",
                table: "Aspirantes",
                column: "datosPersonalesId");

            migrationBuilder.CreateIndex(
                name: "IX_Aspirantes_nivelAcademicoId",
                table: "Aspirantes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DatosPersonales_ubigeoNacimientoId",
                table: "DatosPersonales",
                column: "ubigeoNacimientoId");

            migrationBuilder.CreateIndex(
                name: "IX_DatosPersonales_ubigeoResidenciaId",
                table: "DatosPersonales",
                column: "ubigeoResidenciaId");
